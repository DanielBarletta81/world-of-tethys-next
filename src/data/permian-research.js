export const PERMIAN_RESEARCH_BRIEF = [
  {
    title: 'The Great Dying: Anatomy of Obliteration',
    summary:
  ...
  },
  {
    ...
    worldSignal:
      'Cambrian records of the "Long Burning" describe sky turned copper for generations — not catastrophe, but persistent instability. The first Acoustic Warning Mirrors were built during this analogue period, according to the oldest Sage narratives: not to warn of predators, but to track volcanic pressure waves across the Adria straits before visible ash reached the Stone Archipelago.',
  },
  {
    title: 'The Carnian Pluvial Episode: The Reset',
    summary:
  ...
  },
  {
    ...
    worldSignal:
      'The Tethys Sages cross-referenced the black-shale zones against safe passage routes. "Calm black water turns ominous" is a navigation note in Adria\'s tidal codex — not metaphor but literal instruction. The dead zones had predictable periodicity. Route planning incorporated them like seasonal storms.',
  },
];

export const PERMIAN_WRITING_ANGLES = [
  {
    label: 'The Sound of Extinction',
    guidance:
  ...
  {
    label: 'Recovery as Radical Improvisation',
    guidance:
...
export const PERMIAN_SOURCE_NOTES = [
