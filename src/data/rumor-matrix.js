export const MYTHS = [
  {
    ...
    regions: ['tethys-estuary', 'danian', 'iron-sands', 'pteros', 'sky-city']
  },
  {
    ...
    regions: ['straits-of-dier', 'gargantua-archipelago', 'watcher-volcano']
  },
  {
    id: 'hands-first',
    name: 'The Hands That Came First',
    summary: 'Other hands learned the branches before ours. Their memory lingers in the canopy.',
    regions: ['mystic-woods', 'mystic-woods', 'ironwood', 'ironwoods', 'cambria']
  },
  {
    id: 'burrow-cities',
  ...
  },
  {
    ...
    regions: ['gargantua-archipelago', 'tethys-sea', 'pteros', 'mammoth-hand-island']
  },
  {
    id: 'erased-coast',
    name: 'The Erased Coast',
    summary: 'A coastline removed from record, still pressuring the archive.',
    regions: ['cambria', 'watcher-flats', 'sky-city']
  }
];
