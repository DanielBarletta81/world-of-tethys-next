export const BOOK1_BLOCKS = [
  ...
  },
  {
    ...
    regions: ['sky-city', 'cambria-ruins'],
    signals: {
  ...
  },
  {
    ...
    variants: { low: '', mid: '', high: '' },
    myths: ['sky-city-fall', 'watcher-origin'],
    regions: ['cambria-ruins', 'sky-city'],
    signals: {
...
export const BOOK1_CHAPTERS = {
  ch1: [
    'b1_ch1_sky-city_before_01',
    'b1_ch1_sky-city_before_02'
  ],
  ch2: [
    'sky-city_trial',
    'sky-city_verdict',
