export const PTEROSAURS_RESEARCH_BRIEF = [
  {
    title: 'Hollow-Bone Flight Architecture',
    summary:
    ...
    worldSignal:
      'Fabbri spent six years cataloguing the internal architecture of fallen Pteroswift bones. He called the strut geometry "first architecture" — load-bearing paths made from absence. The Cambrian craft tradition of hollow-tube scaffolding for Sky City derives directly from this study.',
  },
  {
    title: 'Thermal Soaring and the Atmospheric Highway',
    summary:
    ...
    worldSignal:
      'The Cambrian navigation doctrine records it plainly: "When the Adria platforms warm at midday, the sky corridors open." Route timing in the Stone Archipelago was structured around pterosaur thermals. Fabbri mapped the reliable lift columns and Cambrian merchants followed the flock paths.',
  },
  {
    title: 'The Giants: Scale and Launch Mechanics',
    summary:
  ...
  },
  {
    ...
    worldSignal:
      'Tany, the Estuaries Sage, mapped species by feeding zone before mapping them by species. "The filter-feeders move the shallows. The piscivores clear the deep channels. Where neither operates, the fish are uncounted." The Fisheries Codex was structured around the ecological voids pterosaurs left, not the ones they filled.',
  },
  {
    title: 'Neural Superiority and Magnetic Navigation',
    summary:
  ...
  },
  {
    ...
    worldSignal:
      'The Cambrian Sages did not romanticize them. The founding charter of Sky City lists the aerial threat before any governance structure. The architecture came first because the sky was occupied. Adaptation to occupied sky is not poetry — it is load-bearing calculation.',
  },
];

export const PTEROSAURS_WRITING_ANGLES = [
  {
...
export const PTEROSAURS_SOURCE_NOTES = [
