      ...
      <div className="flex overflow-x-auto gap-6 px-6 pb-8 snap-x hide-scrollbar">
        {MARINE_DATA.map((creature) => (
          <motion.div
            ...
            className="relative flex-shrink-0 w-80 bg-[#0f1115] border border-cyan-900/30 rounded-lg overflow-hidden snap-center group shadow-lg"
          >
            {creature.background ? (
              <>
                <div
                  className="absolute inset-0 bg-cover bg-center opacity-[0.14]"
                  style={{ backgroundImage: `url(${creature.background})` }}
                />
                ...
                <div
                  ...
                  style={{
                    backgroundImage: 'radial-gradient(circle at 30% 20%, rgba(255,255,255,0.06), transparent 60%)',
