...
const FRAGMENTS = [
  { id: 'pteros', label: 'Pteros', region: 'pteros', anchor: { x: 0.52, y: 0.68 }, icon: '/img/icons/pteros_island.svg' },
  { id: 'watcher', label: 'Watcher Volcano', region: 'watcher-volcano', anchor: { x: 0.62, y: 0.35 }, icon: '/img/icons/watcher-volcano.svg' },
  { id: 'cambria', label: 'Cambria', region: 'cambria-ruins', anchor: { x: 0.42, y: 0.45 }, icon: '/img/icons/cambria.svg' },
  { id: 'gargantua', label: 'Gargantua', region: 'gargantua-archipelago', anchor: { x: 0.24, y: 0.32 }, icon: '/img/icons/mammoth-hand-island.svg' },
  { id: 'skycity', label: 'Sky City', region: 'sky-city', anchor: { x: 0.48, y: 0.18 }, icon: '/img/icons/sky-city.svg' }
];
