...
export default function CinematicTerminal({ videoId, title, thumbnail }) {
  const [isOpen, setIsOpen] = useState(false);

  // Example: YouTube Embed ID or CloudFront URL
 // const embedUrl = `https://www.youtube.com/embed/${videoId}?autoplay=1&rel=0&modestbranding=1`;
<iframe width="315" height="576" src="https://www.youtube.com/embed/aAbtMoKsNw4" title="World of Tethys Book Series Trailer Sci-fi Romance  #booktok #lifeisbutadream #booktube  #trailer" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  return (
    <>
      {/* 1. The Trigger Card */}
      <div 
