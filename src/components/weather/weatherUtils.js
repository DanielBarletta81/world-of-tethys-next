...
export const PROXY_REGION_MAP = {
  ...
  'sky-city': {
    tethysRegion: 'Sky City',
    realLocation: 'La Paz, Bolivia',
    description: 'High-altitude mountain citadel'
  },
  'watcher-volcano': {
    tethysRegion: 'The Watcher',
    realLocation: 'Mount Etna, Italy',
    description: 'Volcanic caldera and ashfields'
  },
  'mystic-woods': {
    tethysRegion: 'Mystic Woods',
    realLocation: 'Kuala Lumpur, Malaysia',
    description: 'Monsoon canopy and fungal network'
  },
  'ironwoods': {
    tethysRegion: 'Ironwoods',
    realLocation: 'Portland, Oregon',
    description: 'Temperate rainforest stronghold'
  },
  'mammoth-hand-island': {
    tethysRegion: 'Mammoth Hand',
    realLocation: 'Anchorage, Alaska',
    description: 'Subarctic tundra ridges'
  },
  'permian-desert': {
    tethysRegion: 'Permian Desert',
    realLocation: 'Atacama Desert, Chile',
    description: 'Arid salt flats and extinction-scarred dunes'
  },
  'mount-shastea': { 
