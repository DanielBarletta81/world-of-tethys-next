...
import IdentityAirLock from "@/components/IdentityAirLock.jsx"; // The new Ravel-Login
import { Gem, User, Activity, Globe, Zap, Power, Sprout } from "lucide-react";
...
export default function Home() {
  ...
  //  if you want to fade out the drone when intro finishes:
useEffect(() => {
  if (introFinished) {
    // Logic to fade volume of drone from 1.0 to 0 over 2 seconds
  }
}, [introFinished]);
          ...
          <nav className="fixed top-0 inset-x-0 z-50 flex flex-wrap md:flex-nowrap items-center justify-between px-4 md:px-6 py-4 border-b border-white/5 bg-[#050403]/90 backdrop-blur-md shadow-2xl">
            ...
            <div className="flex items-center gap-3 md:gap-6 ml-auto md:ml-0">
              ...
              {authLoading ? (
                ...
                // LOGGED OUT: Show "Establish Link"
                <button 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-8 group relative aspect-video rounded-xl border border-stone-800 overflow-hidden shadow-2xl bg-black">
                ...
                <div className="absolute bottom-6 left-6 space-y-1">
                  ...
                  <h3 className="text-2xl md:text-3xl font-display text-white">Sector 4: Pteros Estuary</h3>
