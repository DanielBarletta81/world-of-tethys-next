...
const FEATURED_CREATURES = [
  { id: 'kronosaurus',   name: 'Kronosaurus',   class: 'Marine Predator', image: '/img/creatures/kronosaurus.png' },
  { id: 'sauroposeidon', name: 'Sauroposeidon', class: 'Titanosaur',      image: '/img/creatures/sauroposeidon.png' },
  { id: 'tapejara',      name: 'Tapejara',      class: 'Aerial Scout',    image: '/img/creatures/tapejara.png' },
  { id: 'suchomimus',    name: 'Suchomimus',    class: 'Delta Predator',  image: '/img/creatures/suchomimus.png' },
  { id: 'tropeognathus', name: 'Tropeognathus', class: 'Pterosaur',       image: '/img/creatures/tropeognathus.png' },
  { id: 'void-shell',    name: 'Void Shell',    class: 'Deep Arthropod',  image: '/img/creatures/void_shell.png' },
  { id: 'volcanic-bird', name: 'Volcanic Bird', class: 'Ash Rider',       image: '/img/creatures/volcanic_bird_hero.png' },
  { id: 'glass-ray',     name: 'Glass Ray',     class: 'Shelf Drifter',   image: '/img/creatures/GlassRay_hero.png' },
];
