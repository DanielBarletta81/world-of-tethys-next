    ...
    <article className="mx-auto max-w-4xl px-6 py-14 md:py-20 text-[#2a1f17]">
      ...
      <section className="rounded-3xl border border-amber-900/30 bg-[linear-gradient(145deg,#fbf6ee,#e9dac5)] p-8 shadow-[0_20px_46px_rgba(35,20,8,0.14)] md:p-10">
        ...
        <p className="mt-5 leading-relaxed text-[#3f3024]">
          ...
          selective launch behavior gave them range advantages over terrestrial hunters. In fragmented volcanic
          landscapes, control of the air translates into control of access, visibility, and pressure.
        </p>
        <p className="mt-4 leading-relaxed text-[#3f3024]">
          In World of Tethys, aerial predators are not just creatures but system-level constraints. They influence
          where people build, how they travel, and when they move resources.
        </p>
      </section>
